...
In this context, the order of the data is essential and plays a critical role in accurately modeling temporal patterns. However, a new method has been introduced that overcomes these limitations. This method is based on simple linear model LTSF-Linear, `Dlinear`, which could get better results compared to other transformer methods. 
In addition, the introduction of a more advanced transformer variant, PatchTST, overcomes the limitations of previous transformer approaches and surpasses the performance of the Dlinear model. <br>
...
This part of result can be found in `test_result` directory.
<br>
